...
use DomainSystem\Plugins\appointments\Contracts\DoctorScheduleWriterInterface;
use DomainSystem\Plugins\doctors\Contracts\DoctorRepositoryInterface;

class AppointmentDoctorProvider implements DoctorReaderInterface, DoctorScheduleWriterInterface
{
    ...
    {
        return $this->repository->getSchedules($doctorId);
    }
