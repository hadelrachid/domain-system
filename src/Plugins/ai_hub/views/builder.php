    ...
    <div style="display: grid; grid-template-columns: 3fr 1fr; gap: 20px; margin-top: 20px;">
        ...
        <div>
            <div style="background: #fff; border: 1px solid #c3c4c7; box-shadow: 0 1px 1px rgba(0,0,0,.04); border-radius: 4px; padding: 20px; margin-bottom: 20px;">
                ...
                <textarea style="width: 100%; height: 100px; padding: 10px; font-family: inherit; border: 1px solid #8c8f94; border-radius: 4px;" placeholder="Ex: Crie um plugin que exiba um formulário de cadastro rápido de paciente. Ao salvar, chame a classe injetada 'PatientRepositoryInterface' para gravar no banco. Mostre mensagem de sucesso."></textarea>
                
                <div style="margin-top: 15px; text-align: right;">
                    <button class="btn" style="background: #2271b1; color: #fff; border: none; padding: 8px 16px; border-radius: 4px; cursor: pointer;">🧠 Gerar com I.A.</button>
                </div>
            </div>
            ...
            <div style="background: #fff; border: 1px solid #c3c4c7; box-shadow: 0 1px 1px rgba(0,0,0,.04); border-radius: 4px;">
                ...
                <div style="padding: 0;">
                    <textarea style="width: 100%; height: 400px; padding: 15px; font-family: Consolas, monospace; border: none; font-size: 14px; background: #1e1e1e; color: #d4d4d4; resize: vertical;" readonly>
